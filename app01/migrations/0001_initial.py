# Generated by Django 2.1.1 on 2019-02-27 07:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='customer',
            name='consultant',
            field=models.ForeignKey(limit_choices_to={'depart_id': 1001}, on_delete=django.db.models.deletion.CASCADE, related_name='consultanter', to='app01.UserInfo', verbose_name='课程顾问'),
        ),
        migrations.AddField(
            model_name='customer',
            name='course',
        ...
        migrations.AddField(
            ...
            name='teacher',
            field=models.ForeignKey(limit_choices_to={'depart_id__in': [1002, 1003]}, on_delete=django.db.models.deletion.CASCADE, to='app01.UserInfo', verbose_name='讲师'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='classlist',
            name='teachers',
            field=models.ManyToManyField(limit_choices_to={'depart__in': [1002, 1005]}, related_name='abc', to='app01.UserInfo', verbose_name='任课老师'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='tutor',
            field=models.ForeignKey(limit_choices_to={'depart': 1001}, on_delete=django.db.models.deletion.CASCADE, related_name='classes', to='app01.UserInfo', verbose_name='班主任'),
        ),
    ]
